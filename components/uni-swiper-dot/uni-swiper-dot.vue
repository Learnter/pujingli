<template>
	<view class="uni-swiper__warp">
		<slot></slot>
		<view v-if="mode === 'default' && navIsShow" class="uni-swiper__dots-box" :style="{'bottom':dots.bottom + 'px'}">
		...
		<view v-if="mode === 'long' && navIsShow" class="uni-swiper__dots-box" :style="{'bottom':dots.bottom + 'px'}">
		...
		<view v-if="mode === 'nav' && navIsShow" class="uni-swiper__dots-box uni-swiper__dots-nav" :style="{'background-color':dotsStyles.backgroundColor}">
			<view class="uni-swiper__dots-nav-item" :style="{'color':dotsStyles.color}">{{(current+1)+"/"+info.length}}
				{{info[current][field]}}</view>
		</view>
		<view v-if="mode === 'indexes' && navIsShow" class="uni-swiper__dots-box" :style="{'bottom':dots.bottom + 'px'}">
