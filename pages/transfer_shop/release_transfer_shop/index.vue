	...
	<view>
		<view class="releabBox">
			...
			<view class="releabListBox">
				<navigator class="releabList" url="zpbasicdata">
				...
				<navigator class="releabList" url="hotohop">
					<view class="releabLitl">
						<text class="text_1">*</text>
						<text>商铺照片</text>
	...
	export default {
		...
		methods: {
			...
			getReleaseTransferShopDraft() {
				...
				var me = this;
				me.$Request.get(me.$api.transferShop.getReleaseTransferShopDraft).then(res => {
					uni.hideLoading();
					if (res.code == 200) {
			...
			checkPostVideo() {
				...
				me.$Request.get(me.$api.transferShop.checkUploadVideoChance).then(res => {
					uni.hideLoading();
					if (res.code == 200) {
						if (res.data) {
