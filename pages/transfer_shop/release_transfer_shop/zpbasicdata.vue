	...
	<view>
		...
		<form @submit="submitRelease">
			<view class="potnqlistBox">
				...
				<view class="potnqlist">
					<view class="potnqlistl">当前经营</view>
				...
				<uni-popup :show="type === 'bottoma'" position="bottom" mode="fixed" msg="行业" @hidePopup="togglePopup('')">
				...
				<view class="potnqlist">
					<view class="potnqlistl">店铺面积</view>
					<view class="potnqlistx">
				...
				<view class="potnqlist">
					<view class="potnqlistl">剩余租期</view>
					<view class="potnqlistx">
						<input class="uni-input" type="text" name='longest_lease' :value="transferShopInfo.longest_lease" placeholder="请输入店铺最长租期 例: 12个月" />
					</view>
				</view>
				<!-- <view class="potnqlist">
					...
					<view class="potnqlistx" @click="togglePopup('bottomc')">
						<view class="znhometopshrtxz">
							...
							<view class="znhomeico"><uni-icon type="arrowdown" color="#666666" size="18"></uni-icon></view>
						</view> 
					</view>
				</view> -->
				...
				<view class="potnqlist">
					...
					<view class="potnqlistx" style="border:none;">
						<input class="uni-input" type="number" name="transfer_price" :value="transferShopInfo.transfer_price ? transferShopInfo.transfer_price / 10000 : ''"
						 placeholder="请输入您的转让费" />
					</view>
		...
		data() {
			return {
				...
				/* rentFreePeriodData: [
					{id:1, day: 0, title: '不免'},
					{id:2, day: 7, title: '7天'},
					{id:3, day: 15, title: '15天'},
					{id:4, day: 30, title: '30天'},
					{id:5, day: 60, title: '60天'}
				],
		...
		methods: {
				...
				me.$Request.get(me.$api.config.region, {
					...
					if (res.code == 200) {
						...
						if(me.transferShopInfo.length > 0) {
							...
							if (me.transferShopInfo.cate_id != undefined) {
								me.topCateId = me.transferShopInfo.top_cate_id;
								me.chooseCateInfo = {
									id: me.transferShopInfo.cate_id
								};
								if (me.chooseCateInfo.id == me.topCateId) {
									me.showCateName = (me.industryCate[me.topCateId].name);
								} else if (me.topCateId > 0 && me.chooseCateInfo.id > 0) {
									me.showCateName = (me.industryCate[me.topCateId].child[me.chooseCateInfo.id].name);
								}
							}
							if (me.transferShopInfo.longitude != undefined && me.transferShopInfo.longitude > 0) {
								me.showChooseLocationContent = '纬度: ' + me.transferShopInfo.latitude + ' 经度: ' + me.transferShopInfo.longitude;
			...
			submitRelease(e) {
				...
				var address = e.detail.value.address,
					...
					longest_lease = e.detail.value.longest_lease,
					transfer_price = e.detail.value.transfer_price,
				...
				// 	});
				// }
				if (me.transferPriceIsFace === false && (transfer_price <= 0 || transfer_price == '')) {
					return uni.showToast({
						title: '请输入转让费',
						duration: 2000,
						icon: 'none'
				...
				me.$Request.post(me.$api.transferShop.releaseTransferShop, {
					...
					longest_lease: longest_lease,
					transferPriceIsFace: me.transferPriceIsFace,
