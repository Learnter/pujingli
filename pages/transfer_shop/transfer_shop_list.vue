<template>
	<view>
		<view>
			<view class="smaNavBoxpos" v-if="operationType == 'you_may_also_like' || operationType == 'featured'">
		...
		methods: {
			...
			cateChoose(type, cateInfo) {
				...
				if (type == 1) {
					...
					if (me.industryCateChild.length == 0) {
						me.type = 'hide';
						me.getTransferShopInfo(true);
					}
				} else {
			...
			getTransferShopInfo(isReload) {
				...
				var me = this;
				me.$Request.get(me.$api.transferShop.transferShopList, {
