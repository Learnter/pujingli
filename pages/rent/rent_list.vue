<template>
	<view>
			...
			<view class="smaNavBoxpos">
				<view class="smaNavBoxpohe">
					<view class="smaNavBox">
						...
						<view class="smaNav" @click="togglePopup('bottomc')">租金 <uni-icon class="i" type="arrowdown" color="#333333" size="18"></uni-icon>
						</view>
					</view>
				</view>
			</view>
							...
							<view class="findconnerhztx">
								...
								<view class="dconnerhcazuo">
									<view class="nerhcazuolyan">
										...
										<view class="nerhcajjolyantx" style="color:#333333;" v-if="item.rent_free_period">免租期: <text style="color:red;">{{item.rent_free_period}}</text></view>
									</view>
		...
		<view style="text-align: center;padding-top:150upx;" v-else>
			...
			<view style="color:#888888;">暂无出租信息</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			var me = this;
			me.operationType = e.type;
			switch (me.operationType) {
				case 2:
					title = '商铺出租';
					break;
				case 3:
		...
		methods: {
			...
			getTransferShopInfo(isReload) {
				...
				var me = this;
				me.$Request.get(me.$api.transferShop.rentList, {
					type: me.operationType,
					city: city,
